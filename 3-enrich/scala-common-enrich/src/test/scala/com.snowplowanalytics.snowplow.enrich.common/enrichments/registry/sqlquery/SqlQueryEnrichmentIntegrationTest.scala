...
class SqlQueryEnrichmentIntegrationTest extends Specification with ValidationMatchers {
  ...
  def e2 = {
    ...
    val geoContext1 = createPair(SchemaKey("com.snowplowanalytics.snowplow", "geolocation_context", "jsonschema", "1-1-0"),
                                 """ {"latitude": 12.5, "longitude": 32.1, "speed": 10.0} """)
    val ue1 = createPair(SchemaKey("com.snowplowanalytics.monitoring.kinesis", "app_initialized", "jsonschema", "1-0-0"),
    ...
    val geoContext2 = createPair(SchemaKey("com.snowplowanalytics.snowplow", "geolocation_context", "jsonschema", "1-1-0"),
                                 """ {"latitude": 12.5, "longitude": 32.1, "speed": 25.0} """)
    val ue2 = createPair(SchemaKey("com.snowplowanalytics.monitoring.kinesis", "app_initialized", "jsonschema", "1-0-0"),
    ...
    val geoContext3 = createPair(SchemaKey("com.snowplowanalytics.snowplow", "geolocation_context", "jsonschema", "1-1-0"),
                                 """ {"latitude": 12.5, "longitude": 32.1, "speed": 2.5} """)
    val ue3 = createPair(SchemaKey("com.snowplowanalytics.monitoring.kinesis", "app_initialized", "jsonschema", "1-0-0"),
    ...
    val geoContext4 = createPair(SchemaKey("com.snowplowanalytics.snowplow", "geolocation_context", "jsonschema", "1-1-0"),
                                 """ {"latitude": 12.5, "longitude": 32.1, "speed": 25.0} """)
    val ue4 = createPair(SchemaKey("com.snowplowanalytics.monitoring.kinesis", "app_initialized", "jsonschema", "1-0-0"),
                         """ {"applicationName": "ue_test_london"} """)
